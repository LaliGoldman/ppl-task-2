...
export type SExpValue = number | boolean | string | PrimOp | Closure | SymbolSExp | EmptySExp | CompoundSExp | DictValue;  // <- added DictValue
...
export const makeDictValue = (dict: Map<string, Value>): DictValue =>
    ({ tag: "DictValue", dict: dict });
...
export const dictValueToString = (dict: DictValue): string => {
